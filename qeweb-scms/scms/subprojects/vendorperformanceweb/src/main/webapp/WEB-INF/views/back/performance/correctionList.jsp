...
<body>
  <table id="datagrid" data-options="
    fit:true,
    url:'${ctx}/manager/vendor/VendorPerforCorrection',method:'post',singleSelect:false,
  ...
  ">
    <thead>
      <tr>
        ...
        <th width="4%" data-options="field:'cycleName',formatter:function(v,r){if(r.cycleEntity) return r.cycleEntity.cycleName;}">评估周期</th>
        <th width="10%" data-options="field:'assessDate'">评估时间</th>
        <th width="9%" data-options="field:'vendorCode'">供应商编码</th>
        <th width="9%" data-options="field:'vendorName'">供应商名称</th>
        <th width="9%" data-options="field:'brandName'">品牌名称</th>
        <th width="9%" data-options="field:'correctionDate'">提出整改要求时间</th>
        <th width="9%" data-options="field:'requireDate'">要求整改完成时间</th>
  ...
  <div id="tt">
	<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-accept',plain:true" onclick="correction.qrs()">确认整改</a>  
	<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-accept',plain:true" onclick="correction.solution()">方案审核</a>  
	<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-accept',plain:true" onclick="correction.endSolutionStart()">整改结案</a>  
 ...
 <div id="win-import" title="方案审核" style="height:80%;width: 700px" data-options="iconCls:'icon-disk_upload',modal:true,closed:true,buttons:'#dialog-adder-bb'" >
	...
	<input type="hidden" id="typee" name="typee" value="" />
	 ...
	 <div id="dialog-adder-bb">
		<a href="javascript:;"  data-options="iconCls:'icon-ok'" class="easyui-linkbutton" onclick="correction.solutionSubmit(1)">审核通过</a>
		<a href="javascript:;"  data-options="iconCls:'icon-no'" class="easyui-linkbutton" onclick="correction.solutionSubmit(2)">审核不通过</a>
	</div>
 </div>
 ...
 <div id="win-import3" title="整改结案" style="width:30%;height:30%;"   
        ...
        <table  style="width: 100%;height: 100%">
     		 <tr>
				...
				<td  style="width: 70%;height: 100%"><textarea id="usContent" name="usContent" style="width:100%;height: 100%"></textarea></td>
			</tr>
		</table>    
	<div id="dialog-adder-bb2">
		<a href="javascript:;"  data-options="iconCls:'icon-ok'" class="easyui-linkbutton" onclick="correction.endSolution()">结案</a>
	</div>
 </div>
<script type="text/javascript">
		$(function(){
