...
public class VendorMaterialRelTransfer {
	...
	@ExcelCol(column = Column.D, required = true,desc="物料图号")
	private String materialCode;
	@ExcelCol(column = Column.E, required = true,desc="物料名称")
	private String materialName;
	@ExcelCol(column = Column.F, desc="供货状态")
	private String status;
	@ExcelCol(column = Column.G, desc="标杆车型")
	private String carModel;//标杆车型
	@ExcelCol(column = Column.H, desc="数据来源")
