package com.qeweb.scm.baselineweb;
...
public class BaseWebServer {
	...
	public static void main(String[] args) throws Exception{
		...
		/* 启动JETTY */
		Server server = JettyFactoryEx.createServerInSource(PORT, CONTEXTPATH,new String[]{"src/main/webapp",
				"../vendorweb/src/main/webapp",
				"../baseweb/src/main/webapp",
				"../purchaseweb/src/main/webapp",
				"../vendorperformanceweb/src/main/webapp",
		});
