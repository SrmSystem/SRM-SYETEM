...
public class BacklogController {
	...
	public Map<String,Object> list(@RequestParam(value="page") int pageNumber,
		...
		//替换参数
		Map<String,String> systemMap =service.getParameters();

		
		List<BacklogCfgEntity> page = service.getList(pageNumber,pageSize,queryParamMap,systemMap,user.orgRoleType);
		//国际化处理
		for(BacklogCfgEntity back : page) {
