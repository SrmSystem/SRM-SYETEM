 ...
 * @author pjjxiajun
 * @date 2015年7月18日
 * @path com.qeweb.scm.vendormodule.web.manager.VendorAdmittanceController.java
 */
@Controller
...
public class VendorAdmittanceController {
	 ...
	 * @return
	 */
	@LogClass(method="查看", module="调查表管理(供)")
	...
	public String viewBaseSurveyPage(@PathVariable("id") Long id,Model model,HttpServletRequest request){
		...
		model.addAllAttributes(surveyInfo);
	 ...
	 * @return 校验信息
	 */
	@RequestMapping("validateSecVen")
	@ResponseBody
	public Map<String,Object> validateSecVen(Long orgId,String mainProIds){
		Map<String,Object> map = vendorSurveyService.validateSecVen(orgId,mainProIds);
		return map;
	}
