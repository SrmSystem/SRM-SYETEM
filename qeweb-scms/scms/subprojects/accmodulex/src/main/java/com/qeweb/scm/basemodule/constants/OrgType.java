...
public class OrgType {
	...
	/** 商务*/
	public final static Integer GROUP_TYPE_BUNIESS=1; 
	/** 技术*/
	public final static Integer GROUP_TYPE_SKILL=2;	  
	
	private static Map<Integer,String> orgTypeMap;
	private static Map<Integer,String> roleTypeMap;
	private static Map<Integer,String> groupTypeMap;
...
//			roleTypeMap.put(ROLE_TYPE_TRANSPORT, "运输商");
	...
	public static Map<Integer, String> getGroupTypeMap() {
		if(groupTypeMap==null){
			groupTypeMap=new HashMap<Integer, String>();
			groupTypeMap.put(GROUP_TYPE_BUNIESS, "商务");
			groupTypeMap.put(GROUP_TYPE_SKILL, "技术");
		}
		return groupTypeMap;
	}
	...
	public static String getGroupTypeMap(Integer key){
		return getGroupTypeMap().get(key);
	}
