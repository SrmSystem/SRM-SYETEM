...
public interface UserDao extends BaseRepository<UserEntity, Serializable>,JpaSpecificationExecutor<UserEntity>{
	...
	public UserEntity findByLoginNameAndAbolished(String loginName,Integer abolished);
	...
	@Query("from UserEntity u where u.loginName =?1 and u.abolished = ?2") 
	public  List<UserEntity> findUserByLoginNameAndAbolished(String loginName,Integer abolished);
