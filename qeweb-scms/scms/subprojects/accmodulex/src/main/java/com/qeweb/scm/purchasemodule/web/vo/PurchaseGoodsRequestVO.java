 ...
 *
 */
public class PurchaseGoodsRequestVO implements Serializable{
	private Long id;
	...
	private Integer type;//1：到货数量 2：剩余匹配量
	private Integer size;//要货计划表头长度
	private String beginRq;//要求到货时间开始时间
	private String endRq;//要求到货时间结束时间
	...
	public String toString() {
		return "PurchaseGoodsRequestVO [id=" + id + ", dhsl=" + dhsl
				+ ", vendorConfirmStatus=" + vendorConfirmStatus
				+ ", publishStatus=" + publishStatus + ", flag=" + flag
				+ ", factoryId=" + factoryId + ", factoryCode=" + factoryCode
				+ ", factoryName=" + factoryName + ", purchasingGroupId="
				+ purchasingGroupId + ", groupName=" + groupName
				+ ", materialId=" + materialId + ", materialCode="
				+ materialCode + ", materialName=" + materialName + ", cdqwl="
				+ cdqwl + ", meins=" + meins + ", ysts=" + ysts + ", shpl="
				+ shpl + ", vendorId=" + vendorId + ", vendorCode="
				+ vendorCode + ", vendorName=" + vendorName + ", type=" + type
				+ ", size=" + size + ", beginRq=" + beginRq + ", endRq="
				+ endRq + ", drawingNumber=" + drawingNumber + ", col0=" + col0
				...
				+ ", col19=" + col19 + ", col20=" + col20 + ", col21=" + col21
				+ ", col22=" + col22 + ", col23=" + col23 + ", col24=" + col24
				+ ", col25=" + col25 + ", col26=" + col26 + ", col27=" + col27
				+ ", col28=" + col28 + ", col29=" + col29 + ", col30=" + col30
				+ ", col31=" + col31 + ", col32=" + col32 + ", col33=" + col33
				+ ", col34=" + col34 + ", col35=" + col35 + ", col36=" + col36
				+ ", col37=" + col37 + ", col38=" + col38 + ", col39=" + col39
				+ ", col40=" + col40 + ", col41=" + col41 + ", col42=" + col42
				+ ", col43=" + col43 + ", col44=" + col44 + ", col45=" + col45
				+ ", col46=" + col46 + ", col47=" + col47 + ", col48=" + col48
				+ ", col49=" + col49 + ", col50=" + col50 + ", col51=" + col51
				+ ", col52=" + col52 + ", col53=" + col53 + ", col54=" + col54
				+ ", col55=" + col55 + ", col56=" + col56 + ", col57=" + col57
				+ ", col58=" + col58 + ", col59=" + col59 + ", col60=" + col60
				+ ", col61=" + col61 + ", col62=" + col62 + ", col63=" + col63
				+ ", col64=" + col64 + ", col65=" + col65 + ", col66=" + col66
				+ ", col67=" + col67 + ", col68=" + col68 + ", col69=" + col69
				+ ", col70=" + col70 + ", col71=" + col71 + ", col72=" + col72
				+ ", col73=" + col73 + ", col74=" + col74 + ", col75=" + col75
				+ ", col76=" + col76 + ", col77=" + col77 + ", col78=" + col78
				+ ", col79=" + col79 + ", col80=" + col80 + ", col81=" + col81
				+ ", col82=" + col82 + ", col83=" + col83 + ", col84=" + col84
				+ ", col85=" + col85 + ", col86=" + col86 + ", col87=" + col87
				+ ", col88=" + col88 + ", col89=" + col89 + ", col90=" + col90
				+ ", col91=" + col91 + ", col92=" + col92 + ", col93=" + col93
				+ ", col94=" + col94 + ", col95=" + col95 + ", col96=" + col96
				+ ", col97=" + col97 + ", col98=" + col98 + ", col99=" + col99
				+ ", col100=" + col100 + "]";
	}
}
