...
@Entity
@Table(name = "qeweb_goods_request_item")
public class GoodsRequestItemEntity extends BaseEntity {
	...
	private Set<GoodsRequestItemPlanEntity> requestItemPlan;
	...
	//冗余字段
	private String storeQty; //三方库存
	private String wmsQty; //wms库存
	private String curMonthPlanQty; //当月采购计划
	private String curOrderQty; //当月已采购量
	...
	@JsonIgnore
	public Set<GoodsRequestItemPlanEntity> getRequestItemPlan() {
		return requestItemPlan;
	}

	public void setRequestItemPlan(Set<GoodsRequestItemPlanEntity> requestItemPlan) {
	...
	@Transient
	public String getCurMonthPlanQty() {
		return curMonthPlanQty;
	}

	public void setCurMonthPlanQty(String curMonthPlanQty) {
		this.curMonthPlanQty = curMonthPlanQty;
	}

	@Transient
	public String getCurOrderQty() {
		return curOrderQty;
	}

	public void setCurOrderQty(String curOrderQty) {
		this.curOrderQty = curOrderQty;
	}
