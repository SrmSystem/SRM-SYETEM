...
public interface ViewDao extends BaseRepository<ViewEntity, Serializable>,JpaSpecificationExecutor<ViewEntity>{
	...
	public List<ViewEntity> findByViewTypeAndAbolishedOrderByMenuSnAsc(int viewMenu,int abolished);
	...
	public List<ViewEntity> findByParentIdAndViewTypeAndIsVendorOrderByMenuSnAsc(Long parentId, int viewType,String isVendor);
}
