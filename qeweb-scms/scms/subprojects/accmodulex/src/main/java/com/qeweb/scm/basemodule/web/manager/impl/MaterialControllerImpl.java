...
public class MaterialControllerImpl implements ILog{
	...
	public Map<String, Object> materialList(int pageNumber, int pageSize, Model model, ServletRequest request) {
		...
		List<MaterialEntity> list = materialService.getMaterialListByBuyer(pageNumber,pageSize,searchParamMap);
		map = new HashMap<String, Object>();
		map.put("rows",list);
		map.put("total",materialService.getMaterialListCount(searchParamMap));
		return map;
	}
