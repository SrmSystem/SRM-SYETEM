 ...
 */
@Entity
@Table(name = "QEWEB_EP_WHOLE_QUO")
public class EpWholeQuoEntity extends EPBaseEntity{
	...
	private String isIncludeTax;				//是否含税
	...
	private Set<EpWholeQuoHisEntity> wholeQuoHises;
	
	private Integer eipStatus;//-1 询比价价格回传结果失败
	
	private Integer priceChangeNum;//价格变动序号 VALTG
	...
	@OneToMany(fetch=FetchType.LAZY, mappedBy = "wholeQuo")
	@Where(clause="abolished=0")
	@JsonIgnore
	public Set<EpWholeQuoHisEntity> getWholeQuoHises() {
		return wholeQuoHises;
	}

	public void setWholeQuoHises(Set<EpWholeQuoHisEntity> wholeQuoHises) {
		this.wholeQuoHises = wholeQuoHises;
	}
	...
	public Integer getPriceChangeNum() {
		return priceChangeNum;
	}

	public void setPriceChangeNum(Integer priceChangeNum) {
		this.priceChangeNum = priceChangeNum;
	}
