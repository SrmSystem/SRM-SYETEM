...
@Entity
@Table(name = "qeweb_purchase_plan_ven_item")
public class PurchasePlanVenodrItemEntity extends BaseEntity {

	private PurchasePlanEntity plan;
	private PurchasePlanVendorEntity vendorPlan;
	...
	public PurchasePlanVendorEntity getVendorPlan() {
		return vendorPlan;
	}

	public void setVendorPlan(PurchasePlanVendorEntity vendorPlan) {
