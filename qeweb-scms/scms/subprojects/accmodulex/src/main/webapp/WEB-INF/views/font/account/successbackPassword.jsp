			...
			<div id="headBox">
				<div class="w960 oh">
					<nav id="navs" class="fr">
						<a href="${ctx}"><spring:message code="vendor.font.LoginInterface"/><!-- 登录界面 --></a>
						<a class="active"><spring:message code="vendor.font.PasswordRetrieval"/><!-- 找回密码 --></a>
					</nav>
				</div>
			</div>
		</header><!-- // header end -->
		<div class="container w960 mt20">
				...
				<ol class="processorBox oh">
					<li>
						<div class="step_inner fl">
							...
							<h4><spring:message code="vendor.font.FillInInformation"/><!-- 填写信息 --></h4>
						</div>
					</li>
					<li>
					...
					<li  class="current">
						<div class="step_inner fr">
							...
							<h4><spring:message code="vendor.font.RetrieveResults"/><!-- 找回结果 --></h4>
						</div>
					</li>
				</ol>
			...
			<div class="content">
				<div id="step1" class="step hide">
					...
					<div style="font-size: 24px;font-weight: 900;text-align: center;">${successBoor }<br/><br/><k id="agreeb" style="color:#EC2020">5</k><spring:message code="vendor.font.AfterSecondsAutoJump"/><!-- 秒后，自动跳转 --></div>
					<div class="toolBar">
