...
<!-- 		<th  width="100px"  data-options="field:'commentYn' ,formatter:function(v,r,i){if(v=='1') return '允许';else return '不允许';}     " >是否评论</th> -->
		<th width="120px" data-options="field:'topYn'   ,formatter:function(v,r,i){if(v=='1') return '<spring:message code="vendor.abnormal.topper"/>';else return '<spring:message code="vendor.abnormal.notTop"/>';}    "><spring:message code="vendor.abnormal.isTop"/></th>
...
<!-- 				<tr>
				...
				<tr>
					...
					<td><spring:message code="vendor.abnormal.permissions"/>:</td><td style="text-align:left"><input class="easyui-textbox" id="companyName"   name="vendorNames"  data-options="editable:false,required:true"  type="text"/>
					<a href="javascript:;" class="easyui-linkbutton"  id="select" onclick="lookUser()"><spring:message code="vendor.abnormal.select"/></a>
					</td>
				</tr>
				<tr>
				<td>
