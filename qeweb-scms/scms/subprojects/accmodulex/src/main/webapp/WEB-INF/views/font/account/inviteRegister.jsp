...
<html>
<head>
	<title><!-- 受邀注册 --><spring:message code="vendor.font.InvitedToRegister"/> </title>
			...
			<div id="headBox">
				<div class="w960 oh">
					<nav id="navs" class="fr">
						<a href="${backherf}"><spring:message code="vendor.font.LoginInterface"/><!-- 登录界面 --></a>
				...
				<div id="step1" class="step hide" style="  margin-left: 20%;">
						...
						<div class="frm_control_group">
							...
							<div class="frm_controls">
								...
								<p class="frm_tips"><spring:message code="vendor.font.EnterpriseName"/><!-- 企业全称 -->--<spring:message code="vendor.font.Required"/><!-- 必填项 --></p>
							</div>
						</div>
						<div class="frm_control_group">
						...
						<div class="frm_control_group">
							...
							<div class="frm_controls">
								...
								<p class="frm_tips"><spring:message code="vendor.font.InvitedToRegister"/><spring:message code="vendor.font.AsALoginAccountPleaseFillInTheNonRegisteredLoginName"/><!-- 作为登录帐号，请填写未被注册的登录名 --></p>
							</div>
						</div>
						<div class="frm_control_group">
							<label class="frm_label"><spring:message code="vendor.font.InvitedToRegister"/><spring:message code="vendor.font.Nickname"/><!-- 昵称 --></label>
							<div class="frm_controls">
						...
						<div class="frm_control_group" style="display: none;"> 
							...
							<div class="frm_controls">
							    <input type="text" id="buyerId" name="buyerId" readonly="readonly" value="${buyerId }" class="frm_input required"/>
								<p class="frm_tips"></p>
							</div>
						</div>
						<div class="toolBar">
						    <input id="nextBtn" class="btn btn_primary" type="submit" onclick="saveSub()" value="下一步"/>&nbsp;	
						</div>
					</form>
				</div><!-- // step1 end -->
