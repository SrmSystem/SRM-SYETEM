...
<script type="text/javascript">
            ...
            AmCharts.ready(function () {
                ...
                valueAxis.title = "供应商数量统计图 (by 产品品类、供应商性质)";
...
<div title="统计"  style="height:50%;">
  <table id="datagrid-vendorCount" class="easyui-datagrid" data-options="
    url:'${ctx}/manager/vendor/statistics/statiVendorCountList/3',method:'post',singleSelect:false,
    pagination:true,rownumbers:true,pageSize:15,pageList:[15,30,50,100],
    toolbar:'#tt',fit:true
  ">
    <thead>
      <tr>
        <th data-options="field:'provinceText'">零部件类别</th>
