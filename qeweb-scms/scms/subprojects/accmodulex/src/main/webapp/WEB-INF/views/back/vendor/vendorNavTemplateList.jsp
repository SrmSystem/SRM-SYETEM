...
<body style="margin:0;padding:0;">
	<table id="datagrid-vendorNavTemplate-list" title="向导模版列表" class="easyui-datagrid"
		...
		<th data-options="field:'buyer.name'">采购组织名称</th>
		<th data-options="field:'buyer.code'">采购组织编码</th>
	...
	<div id="vendorNavTemplateListToolbar" style="padding:5px;">
		...
		<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-delete',plain:true" onclick="VendorNavTemplate.del()">删除</a> 
		</div>
		<div>
