...
<body style="margin:0;padding:0;">
	<table id="datagrid-materialRel-list" class="easyui-datagrid" fit="true"
		data-options="url:'${ctx}/manager/vendor/materialRel',method:'post',singleSelect:true,
		...
		<!-- 
		<th data-options="field:'buyerCode',formatter:function(v,r,i){return v==null?'':v.buyer.code;}">采购组织代码</th>
		<th data-options="field:'buyerName',formatter:function(v,r,i){return v==null?'':v.buyer.name;}">采购组织名称</th>
		 -->
	...
	<div id="materialRelListToolbar" style="padding:5px;">
		...
		<!--<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-delete',plain:true" onclick="VendorMaterialRel.del()">删除</a>-->
...
">
  ...
  <div class="easyui-layout" data-options="fit:true">
    <div class="easyui-panel" data-options="region:'west',width:400,border:false">
    <div class="easyui-layout" fit="true" border="false">
    <div class="easyui-panel" data-options="region:'north',border:false,height:250,title:'可选物料列表',
    ...
    <div class="easyui-panel" data-options="region:'center',title:'已选物料列表,右边按钮可移除已选项',
    tools:[{
        text:'移除',
        iconCls:'icon-remove',
    ...
    <div class="easyui-panel" data-options="region:'center',width:300,border:false">
      <div class="easyui-layout" fit="true">
        <div class="easyui-panel" data-options="region:'north',height:250,title:'可选供应商',
        ...
        ">
          <table id="dialog-editor-ven-select" class="easyui-datagrid" data-options="
            ...
            queryParams : {'search-EQ_abolished':0,'search-EQ_phaseSn':3},
            pagination:true,rownumbers:true,pageSize:5,pageList:[5,10,15,20],
            toolbar:'#dialog-editor-ven-select-tt'
          ">
            <thead>
              <th data-options="field:'id',checkbox:true"></th>
              <th data-options="field:'orgCode',formatter:function(v,r,i){return r.org.code;}">供应商代码</th>
              <th data-options="field:'orgName',formatter:function(v,r,i){return r.org.name;}">供应商名称</th>
            </thead>
          
          </table>
        </div>
        <div class="easyui-panel" data-options="region:'center',title:'已选供应商',
        tools:[{
              iconCls:'icon-remove',
    ...
    <div class="easyui-panel" data-options="region:'east',width:300,border:false">
      <div class="easyui-layout" fit="true">
        <div class="easyui-panel" data-options="region:'north',height:250,title:'可选采购组织',
        tools:[{iconCls:'icon-ok',title:'选择',handler:function(){VendorMaterialRel.Buyer.select()}}]
        ">
          <table id="dialog-editor-buyer-select" class="easyui-datagrid" data-options="
            fit:true,border:false,
            url:'${ctx}/manager/vendor/vendorBaseInfo/getBuyerList',
            queryParams : {'search-EQ_abolished':0},
            pagination:true,rownumbers:true,pageSize:5,pageList:[5,10,15,20],
            toolbar:'#dialog-editor-buyer-select-tt'
          ">
            <thead>
              <th data-options="field:'id',checkbox:true"></th>
              <th data-options="field:'code'">采购组织代码</th>
              <th data-options="field:'name'">采购组织名称</th>
            </thead>
          
          </table>
        </div>
        <div class="easyui-panel" data-options="region:'center',title:'已选采购组织',
        tools:[{
              iconCls:'icon-remove',
              handler:function(){VendorMaterialRel.Vendor.removeSelected('#dialog-editor-buyer-selected')}
            }]
        ">
          <table id="dialog-editor-buyer-selected" class="easyui-datagrid" data-options="
            fit:true,border:false,
            idField:'id'
           ">
           <thead>
            <tr>
            <th data-options="field:'id',checkbox:true"></th>
            <th data-options="field:'code',width:160">采购组织代码</th>
            <th data-options="field:'name',width:200">采购组织名称</th>
            </tr>
            </thead>
          </table>
        </div>
...
<form id="form-supply-vendor-select" method="post">
  供应商代码:<input class="easyui-textbox" type="text" name="search-LIKE_org.code" style="width:80px;"/>
  供应商名称:<input class="easyui-textbox" type="text" name="search-LIKE_org.name" style="width:80px;"/>
 <a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="VendorMaterialRel.Vendor.search()">查询</a>
</form>
</div>

<div id="dialog-editor-buyer-select-tt">
<form id="form-supply-buyer-select" method="post">
<input type="hidden" name="search-EQ_abolished" value="0"/>
采购组织代码:<input class="easyui-textbox" type="text" name="search-LIKE_code" style="width:80px;"/>
采购组织名称:<input class="easyui-textbox" type="text" name="search-LIKE_name" style="width:80px;"/>
 <a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="VendorMaterialRel.Buyer.search()">查询</a>
</form>
</div>
	...
	<div id="win-materialSupplyRel" class="easyui-window" title="供货关系详情" style="width:80%;height:100%"
	data-options="modal:true,closed:true">
			<table id="datagrid-materialSupplyRel-list" class="easyui-datagrid"
				...
				>
					...
					<th data-options="field:'vendorBaseInfoEntity',formatter:function(v,r,i){return v==null?'':v.org.code;}">供应商代码</th>
					<th data-options="field:'vendorName'">供应商名称</th>
					
					<th data-options="field:'materialEntity',formatter:function(v,r,i){return v==null?'':v.code;}">物料图号</th>
					<th data-options="field:'materialName'">物料名称</th>
					...
					<th data-options="field:'effectiveTime'">生效时间</th>
					</tr></thead>
			</table>
	<div id="materialSupplyRelListToolbar" style="padding:5px;">
		...
		<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-delete',plain:true" onclick="VendorMaterialSupplyRel.del()">删除</a>
	...
	<div id="win-materialSupplyRel-import" class="easyui-window" title="导入供货关系" style="width:400px;height:200px" data-options="iconCls:'icon-disk_upload',modal:true,closed:true" >
		...
		<div id="win-materialSupplyRel-addoredit" class="easyui-window" title="新增供货关系详情" style="width:600px;height:350px"
		...
		<div class="easyui-panel" data-options="fit:true">
			<form id="form-materialSupplyRel-addoredit" method="post" >
				...
				<tr>
					<td>供货系数</td>
					<td>
						<input id="supplyCoefficient" name="supplyCoefficient" class="easyui-numberbox" min="0" max="1" precision="2" />
					</td>
				</tr>
				<tr>
					<td>生效时间</td>
					<td>
						<input name="effectiveTime" class="easyui-datetimebox" data-options="required:true"/>
					</td>
				</tr>
				</table>
				<div style="text-align: center;padding:5px;">
