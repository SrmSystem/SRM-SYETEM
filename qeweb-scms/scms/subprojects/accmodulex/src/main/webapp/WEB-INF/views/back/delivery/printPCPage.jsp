		...
		<div >
			<table style="font-size: 10px;border-collapse:collapse;margin: 0;padding: 0"   border="0" cellspacing="0" cellpadding="0">
				<tbody>
				     ...
				     <tr>   
				        <td class="small"><!-- AAC料号 --><spring:message code="purchase.delivery.AACMaterialNumber"/>
				        :${pc.materialCode}</td>
				     </tr>
				     <tr>   
				        <td ><img  src="${ctx }/barcode?code=${pc.materialCode }&type=code128&h=5"></td>
				     </tr>
				     <tr>   
				     ...
				     <tr>   
				        <td ><img  src="${ctx }/barcode?code=${pc.materialVersion }&type=code128&h=5"></td>
				     </tr>
				     ...
				     <tr>   
				        <td class="small"><img  src="${ctx }/barcode?code=${pc.boxNum }&type=code128&h=5"></td>
				     </tr>
				     ...
				     <tr>   
				        <td ><img  src="${ctx }/barcode?code=${pc.charg }&type=code128&h=5"></td>
				     </tr>
				     ...
				     <tr>   
				        <td ><img  src="${ctx }/barcode?code=${pc.manufactureDate }&type=code128&h=5"></td>
				     </tr>
