...
<body style="margin:0;padding:0;">
	...
	<div id="vendorPhaseListToolbar" style="padding:5px;">
		...
		<a href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-delete',plain:true" onclick="VendorPhase.del()">删除</a>
		</div>
		<div>
			...
			<a href="javascript:;" class="easyui-linkbutton" onclick="$('#form-vendorPhase-search').form('reset')">重置</a>
			</form>
		</div>
	</div>
		...
		<div class="easyui-panel" data-options="fit:true">
			<form id="form-vendorPhase-addoredit" method="post" >
				...
				<div style="text-align: center;padding:5px;">
					...
					<a href="javascript:;" class="easyui-linkbutton" onclick="$('#form-vendorPhase-addoredit').form('reset')">重置</a>
				</div>
			</form>
		</div>
	</div>
