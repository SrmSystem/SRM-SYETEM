...
<table id="tb" type="tb" class="table table-bordered table-condensed" >
        ...
        <tbody>
        <tr fixed="true"> 
            <td>${vendorSurveyCfgEntitys.id }</td>
            ...
            <td><fmt:formatDate value="${vendorSurveyCfgEntitys.vendorSurveyBaseEntitys.lastUpdateTime }" type="date" dateStyle="medium"/></td>
        </tr> 
        </tbody>  
       </c:forEach>   
</table>
