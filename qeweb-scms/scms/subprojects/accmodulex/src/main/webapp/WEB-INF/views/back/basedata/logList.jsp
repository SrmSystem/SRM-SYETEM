...
<html>
<head>
	<title><!-- 日志管理 --><spring:message code="purchase.basedata.LogManagement"/></title>
  ...
  <div id="tt">
    <div>
      <form id="form" method="post">
        ...
        <spring:message code="base.OperatingTime"/><!-- 操作时间 -->:<input type="text" id="startTime" name="search-GTE_createTime" data-options="editable:false" class="easyui-datetimebox" style="width:100px;"/>
		- <input type="text" id="endTime" name="search-LTE_createTime" data-options="editable:false" class="easyui-datetimebox" style="width:100px;"/>
