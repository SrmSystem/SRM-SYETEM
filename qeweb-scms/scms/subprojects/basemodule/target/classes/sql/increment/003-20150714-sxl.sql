...
Date: 2015-07-14 16:47:08
*/


-- ----------------------------
-- Table structure for QEWEB_COMMENT
-- ----------------------------
DROP TABLE "QEWEB_COMMENT";
CREATE TABLE "QEWEB_COMMENT" (
"ID" NUMBER(11) NOT NULL ,
"NOTICE_ID" NUMBER(11) NULL ,
"CONTENT" NVARCHAR2(255) NULL ,
"COMMENT_TYPE" NUMBER(1) NULL ,
...
;
COMMENT ON COLUMN "QEWEB_COMMENT"."ABOLISHED" IS '废除标记';
...
-- ----------------------------
-- Indexes structure for table QEWEB_COMMENT
-- ----------------------------

-- ----------------------------
-- Checks structure for table QEWEB_COMMENT
-- ----------------------------
ALTER TABLE "QEWEB_COMMENT" ADD CHECK ("ID" IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table QEWEB_COMMENT
-- ----------------------------
ALTER TABLE "QEWEB_COMMENT" ADD PRIMARY KEY ("ID");
