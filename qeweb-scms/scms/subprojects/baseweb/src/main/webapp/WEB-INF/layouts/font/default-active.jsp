...
<html>
<head>
<title><%=ProjectContextUtil.getProjectName() %>-<sitemesh:title/></title>
...
<link href="${ctx}/static/base/bootstrap/2.3.2/css/bootstrap.min.css" type="text/css" rel="stylesheet" />
<link href="${ctx}/static/base/jquery-validation/1.11.1/validate.css" type="text/css" rel="stylesheet" />
<link href="${ctx}/static/base/styles/login.css" type="text/css" rel="stylesheet" />
...
<script src="${ctx}/static/base/jquery-validation/1.11.1/messages_bs_zh.js" type="text/javascript"></script>
