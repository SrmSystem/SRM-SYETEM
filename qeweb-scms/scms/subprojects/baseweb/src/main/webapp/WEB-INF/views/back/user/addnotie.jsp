...
.tag button {
    ...
    cursor: pointer;
	 ...
	 <div class="stay-list-left" style="overflow:auto;">
        ...
        <form>
            <div class="sea-div">
                <label class="search-lab">公告名称</label><input type="text" class="hotel-name" id="disHotel"/>
            </div>
            <div class="sea-div">
            ...
            <div class="sea-div">
                <label class="search-lab">开始日期</label><input type="text" readonly  id="startDate" style="width: 30%"/>
                <label class="search-lab" style="width: 10px"></label>
                <label class="search-lab">结束日期</label><input type="text" readonly  id="endDate" style="width: 30%"/>
            ...
            <br/>
					<textarea id="content1" name="content1" style="width: 100%"></textarea>
					 <a href="javascript:;" class="easyui-linkbutton" style="width: 100px;height:50px;
               			display: block;float: left;margin: 10px 0px 0px 45%;cursor: pointer;" onclick="addnotie()">保存并发布</a>
            </div>
        </form>
    </div>
