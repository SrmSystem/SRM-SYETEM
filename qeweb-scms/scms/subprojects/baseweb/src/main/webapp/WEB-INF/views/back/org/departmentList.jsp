...
<body style="margin:0;padding:0;">
	...
	<div id="menu-department" class="easyui-menu">
		<div id="menu-department-add" onclick="addDepartment()" data-options="iconCls:'icon-add'">添加部门</div>
		<div id="menu-department-edit" onclick="editDepartment()" data-options="iconCls:'icon-edit'">编辑部门</div>
		<div id="menu-department-del" onclick="delDepartment()" data-options="iconCls:'icon-delete'">删除部门</div>
	</div>
		...
		<div class="easyui-panel" data-options="fit:true">
			<form id="form-department-addoredit" method="post" >
				...
				<tr id="tr-department-code">
					<td>编码:</td><td><input class="easyui-textbox" name="code" type="text"
						data-options="disabled:true"
					/></td>
				</tr>
				<tr>
					<td>名称:</td><td><input class="easyui-textbox" name="name" type="text"
						data-options="required:true"
					/></td>
				</tr>
				<tr>
					<td>负责人:</td><td><input class="easyui-textbox" name="legalPerson" type="text"
						data-options="required:true"
					/></td>
				</tr>
				</table>
				<div style="text-align: center;padding:5px;">
					<a href="javascript:;" class="easyui-linkbutton" onclick="submitAddorEditDepartment()">提交</a>
					<a href="javascript:;" class="easyui-linkbutton" onclick="$('#form-department-addoredit').form('reset')">重置</a>
				</div>
			</form>
		</div>
	</div>	
