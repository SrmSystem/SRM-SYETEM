...
var _3=$("<span class=\"textbox\">"+"<input class=\"textbox-text\" autocomplete=\"on\">"+"<input type=\"hidden\" class=\"textbox-value\">"+"</span>").insertAfter(_2);
var _4=$(_2).attr("name");
if(_4){
...
$("<input type=\""+_8.type+"\" class=\"textbox-text\" autocomplete=\"on\">").prependTo(tb);
}
