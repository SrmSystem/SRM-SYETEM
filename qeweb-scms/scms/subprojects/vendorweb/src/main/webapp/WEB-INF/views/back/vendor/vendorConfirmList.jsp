...
<div class="easyui-layout" data-options="fit:true">
  <div class="easyui-panel" data-options="region:'center'">
	<table id="datagrid" title="待确认供应商" class="easyui-datagrid"
		...
		queryParams:{'search-NEQ_org.confirmStatus':1,'search-EQ_org.confirmStatus':0},
		toolbar:'#tt',
	...
	<div id="tt" style="padding:5px;">
		...
		<div>
			...
			<select name="search-EQ_org.confirmStatus" class="easyui-combobox"  style="width:80px;" >
