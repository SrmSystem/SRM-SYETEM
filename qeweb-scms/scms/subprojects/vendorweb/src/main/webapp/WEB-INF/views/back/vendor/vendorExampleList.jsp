  ...
  <div id="tt">
    <div>
      ...
      <form id="form" method="post">
                             ...
                             供应商编号:<input class="easyui-textbox" name="search-LIKE_vendorBaseInfoEntity.code" type="text" style="width:80px;"/>
                             ...
                             物料图号:<input class="easyui-textbox" name="search-LIKE_materialEntity.code" type="text" style="width:80px;"/>
