...
<script type="text/javascript">
            ...
            AmCharts.ready(function () {
                ...
                valueAxis.title = "供应商数量统计图 (by 供应商分类)";
...
<div title="统计"  style="height:50%;">
  <table id="datagrid-vendorCount" class="easyui-datagrid" data-options="
    url:'${ctx}/manager/vendor/statistics/statiVendorCountList/6',method:'post',singleSelect:false,
    pagination:true,rownumbers:true,pageSize:15,pageList:[15,30,50,100],
    toolbar:'#tt',fit:true
  ">
    <thead>
      <tr>
        <th data-options="field:'vendorClassify2'">供应商分类</th>
  ...
  <div id="tt">
	...
	<div>
      <form id="form-search">
       ...
       <a href="javascript:;" class="easyui-linkbutton" onclick="$('#form-search').form('reset')">重置</a>             
      </form>
    </div>
  </div>
</div>
