	...
	data-options="iconCls:'icon-add',closed:true">
		<div class="easyui-panel" data-options="fit:true">
			<form id="form-vendorInviteReg-addoredit" method="post" >
				...
				<tr>
					<td>供应商联系邮箱:</td><td><input class="easyui-textbox" name="vendorEmail" type="text"
						data-options="required:true"
					/></td>
				</tr>
				<tr>
					<td>邀请失效日期:</td><td><input class="easyui-datetimebox" name="expiryDate" data-options="required:true"
					/></td>
				</tr>
				<tr>
