...
<body>
  <div title="基本信息" class="container-fluid text-right">   
   <fieldset><legend class="text-left"><span class="label label-primary"><small>企业所有权信息</small></span></legend>
    ...
    <div class="row row-form">
          <div class="col-md-4">进入福田公司年份:<input class="easyui-textbox" style="width:160px;"/></div>
          <div class="col-md-4">离开福田公司年份:<input class="easyui-textbox" style="width:160px;"/></div>
    </div>
    </fieldset>
    </div>
