	...
	submit : function() {
	    ...
	    $.each(vendorList,function(i,vendor){
	    	$.each(supMatRowList,function(j,mat){
				 var venMatRel = {orgId:vendor.orgId,vendorId:vendor.id,vendorName:vendor.name,materialId:mat.id,materialName:mat.name,dataFrom:mat.dataFrom,status:1};
